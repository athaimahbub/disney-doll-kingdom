...
const DollBlog = () => {
    return (
        <div className='my-12'>
            <h2 className='text-center mb-8 text-4xl text-blue-800 font-bold'>Disney Doll's Blog</h2>
            <div className="container mx-auto mt-8">
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  <div className="card w-96 bg-base-100 shadow-xl border-solid border-2 border-gray-400 rounded">
                    
                  <div className="card-body   ">
                   <h2 className="card-title text-blue-600 text-center font-bold">Disney princess</h2>
